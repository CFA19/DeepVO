...
def test(flownet, model, config):
    ...
    dataset = VisualOdometryDataLoader(config['datapath'], 375, 1242, config['bsize'], test=True, 
                                       sequence_test=config['sequence'])
...
def main():
    ...
    config = {
        'datapath': '/media/cfa/CFA4TB/VIT/PhD/Research/PhDTest/Datasets/datasets/datasetrgb/dataset/seq',
