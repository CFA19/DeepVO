...
class VisualOdometryDataLoader:
    def __init__(self, datapath, height, width, batch_size, test=False, val=False, sequence_test='10'):
        ...
        self.base_path = 'E:\VIT\PhD\\Research\PhDTest\Datasets\datasets\datasetrgb\dataset'
        #self.base_path ='/media/cfa/CFA4TB/VIT/PhD/Research/PhDTest/Datasets/datasets/datasetrgb/dataset'
        if test or val:
            ...
            #self.sequences = ['00', '02', '04']
            self.sequences = ['00', '02', '04','08']
...
def main():
    #path = '/media/cfa/CFA4TB/VIT/PhD/Research/PhDTest/Datasets/datasets/datasetrgb/dataset'
    path = 'E:\VIT\PhD\\Research\PhDTest\Datasets\datasets\datasetrgb\dataset'
    #dataset = VisualOdometryDataLoader(path, 192, 640, 16)
    dataset = VisualOdometryDataLoader(path, 375, 1242, 16)
