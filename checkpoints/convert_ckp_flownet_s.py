...
path = '/media/cfa/CFA4TB/VIT/PhD/Research/PhDTest/2023/working/VisualOdometry-master/FlowNet/checkpoint/checkpoints/FlowNetS'
file = 'flownet-S.ckpt-0'
trained_checkpoint_prefix = os.path.join(path, file)
net = FlowNetS(375, 1242)
